      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="font-display font-bold text-white text-2xl mb-4">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary-400 to-secondary-400">SafeWorkPay</span>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="https://twitter.com" aria-label="Twitter" className="text-gray-400 hover:text-primary-400 transition-colors">
                <FaTwitter className="text-xl" />
              </a>
              <a href="https://github.com" aria-label="GitHub" className="text-gray-400 hover:text-primary-400 transition-colors">
                <FaGithub className="text-xl" />
              </a>
              <a href="https://discord.com" aria-label="Discord" className="text-gray-400 hover:text-primary-400 transition-colors">
                <FaDiscord className="text-xl" />
              </a>
              <a href="https://linkedin.com" aria-label="LinkedIn" className="text-gray-400 hover:text-primary-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/freelancers" className="text-gray-400 hover:text-white transition-colors">Find Talent</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 text-center text-xs text-gray-600">
          <p className="flex items-center justify-center">
            Built with <FaHeart className="text-red-500 mx-1" /> on the Ethereum blockchain
          </p>
        </div>
      </div>
    </footer>
