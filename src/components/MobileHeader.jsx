...
const MobileHeader = ({ toggle, isOpen }) => {
  ...
  const navLinkClasses = (path) => {
    return `flex items-center justify-between py-3 px-4 rounded-lg transition-all duration-300 ${
      isActive(path)
  ...
  return (
    ...
    >
      ...
      <nav
        className={`fixed right-0 top-0 bottom-0 w-80 max-w-sm bg-white/95 backdrop-blur-sm shadow-2xl flex flex-col overflow-y-auto h-full transform transition-all duration-500 ease-in-out ${
        ...
        <div className="flex flex-col space-y-2 px-4 pt-2">
          ...
          >
            <div className="flex items-center space-x-3">
              <div
                className={`p-2 rounded-md ${
                  isActive("/mybids") ? "bg-primary-100" : "bg-gray-100"
                }`}
              >
                <FaClipboardList
                  className={`${
                    isActive("/mybids") ? "text-primary-500" : "text-gray-500"
                  }`}
                />
              </div>
              <span>My Bids</span>
          ...
          >
            <div className="flex items-center space-x-3">
              <div
                className={`p-2 rounded-md ${
                  isActive("/myjobs") ? "bg-primary-100" : "bg-gray-100"
                }`}
              >
                <FaBriefcase
                  className={`${
                    isActive("/myjobs") ? "text-primary-500" : "text-gray-500"
                  }`}
                />
              </div>
              <span>My Jobs</span>
          ...
          >
            <div className="flex items-center space-x-3">
              <div
                className={`p-2 rounded-md ${
                  isActive("/myprojects") ? "bg-primary-100" : "bg-gray-100"
                }`}
              >
                <FaFolder
                  className={`${
          ...
          >
            <div className="flex items-center space-x-3">
              <div
                className={`p-2 rounded-md ${
                  isActive("/messages") ? "bg-primary-100" : "bg-gray-100"
                }`}
              >
                <FaComments
                  className={`${
                    isActive("/messages") ? "text-primary-500" : "text-gray-500"
                  }`}
                />
              </div>
              <span>Messages</span>
              <span className="inline-flex items-center justify-center w-5 h-5 ml-1 text-xs font-medium text-white bg-accent-500 rounded-full">
                2
              </span>
            </div>
            <FaAngleRight className="text-gray-400" />
          ...
          {isAdmin && (
            <>
              ...
              <h3 className="text-xs font-medium text-accent-500 uppercase tracking-wider mb-1 px-2">
                Admin
              </h3>
              <Link
          ...
          <div className="border-t border-gray-100 my-3 pt-3">
            <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-xl p-4 shadow-inner">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Contact support for assistance with your account or
                transactions.
              </p>
