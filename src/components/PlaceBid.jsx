        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="my-6">
            ...
            <div className="text-xs text-gray-500 mt-2">
              Make your best offer. Remember that the job owner is looking for the right balance of quality and cost.
            </div>
          </div>
          ...
          {jobListing && (
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              ...
              <p className="text-sm text-gray-600 mt-1">{jobListing.jobTitle}</p>
              <div className="flex items-center gap-2 mt-2">
                <div className="badge-primary">${jobListing.minBudget} - ${jobListing.maxBudget}</div>
              </div>
            </div>
          )}
